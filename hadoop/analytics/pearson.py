...
df_mongo = sesh.read.json('hdfs://n1:9000/metadata/metadata.json')
...
for i in range(len(files)-3):
        df_review_i =  sesh.read.option('header', False).option( 'delimiter', '_').schema(schema).csv('hdfs://n1:9000/user/hadoop/reviews/part-m-0000{}'.format(i+1))
